...
var routes = function () {
    ...
    .post('/forgotPassword', passport.authenticate('jwt-auth-api', { session: false }), function (req, res) {
        ...
        var mailOptions = {
            ...
            //text: "Test from AWS ", // plaintext body
            html: "Please click on link to reset your password:  http://" + config.ses_host_name + "/#/password_reset/" + data.AccountID + "/" + data.InviteID
        };
